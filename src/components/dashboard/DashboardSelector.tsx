          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <CardHeader className="text-center">
                ...
                <CardDescription>For recruiters and hiring managers</CardDescription>
              </CardHeader>
            ...
            >
              <CardHeader className="text-center">
                ...
                <CardDescription>For candidates looking for opportunities</CardDescription>
              </CardHeader>
              <CardContent className="text-center">
