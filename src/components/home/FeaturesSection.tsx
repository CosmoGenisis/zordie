...
import { Users, Bot, ShieldCheck, Clock, CheckCircle, BarChart, Video, Award, Zap, Search, MessageSquare, Settings, Github, Linkedin } from 'lucide-react';
  ...
  return <section ref={sectionRef} className="py-24 relative overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"}>
          <SectionHeading title="AI-Powered Hiring Platform" subtitle="Tailored solutions for companies and job seekers" align="center" />
          
          <Tabs defaultValue="companies" className="w-full mt-12">
            <div className="flex justify-center mb-10">
              <TabsList className="grid grid-cols-2 w-full max-w-md">
                <TabsTrigger value="companies" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-zordie-600 data-[state=active]:to-accent1 data-[state=active]:text-white">
                  For Companies
                </TabsTrigger>
                <TabsTrigger value="jobseekers" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-zordie-600 data-[state=active]:to-accent1 data-[state=active]:text-white">
                  For Job Seekers
                </TabsTrigger>
              </TabsList>
            </div>
            ...
            <TabsContent value="companies">
              <div className="grid md:grid-cols-2 gap-16 items-center">
                <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"} className="order-2 md:order-1">
                  <motion.h3 className="text-3xl font-bold mb-6 text-zordie-800 dark:text-white" variants={itemVariants}>
                  ...
                  <motion.div className="space-y-6" variants={containerVariants}>
                    <FeatureItem icon={<Bot className="text-zordie-600" />} title="AI-Powered Screening" description="Our AI automatically scans and ranks resumes based on job requirements." variants={itemVariants} />
                    
                    <FeatureItem icon={<ShieldCheck className="text-zordie-600" />} title="Credential Verification" description="Automatically verify skills, projects, and credentials with connected profiles." variants={itemVariants} />
                    
                    <FeatureItem icon={<Video className="text-zordie-600" />} title="Automated Video Interviews" description="AI-analyzed video screening with real-time scoring reduces interview time by 73%." variants={itemVariants} />
                    
                    <FeatureItem icon={<BarChart className="text-zordie-600" />} title="Comprehensive Analytics" description="Detailed scorecards and candidate rankings based on verified skills and interview performance." variants={itemVariants} />
                  </motion.div>
                  
                  <motion.div className="mt-10" variants={itemVariants}>
                    <Link to="/companies">
                      <Button size="lg" className="bg-gradient-to-r from-zordie-600 to-accent1 hover:from-zordie-700 hover:to-accent1-hover relative overflow-hidden group">
                ...
                <motion.div className="order-1 md:order-2 relative" variants={itemVariants}>
                  <div className="relative bg-white dark:bg-zordie-800 p-8 rounded-xl shadow-xl border border-gray-200 dark:border-zordie-700">
                    ...
                    <div className="space-y-4">
                      <ScreeningStep number={1} title="Resume Analysis" description="AI parses resumes and extracts relevant skills and experience" />
                      
                      <ScreeningStep number={2} title="Credential Verification" description="Connected profiles verified to eliminate fake resumes" />
                      
                      <ScreeningStep number={3} title="Automated Interviews" description="AI video interviews with real-time scoring" />
                      
                      <ScreeningStep number={4} title="Candidate Ranking" description="Detailed scoring and ranking of verified candidates" />
                      
                      <ScreeningStep number={5} title="Hiring Decision" description="Final selection based on comprehensive AI analysis" />
                    </div>
            ...
            <TabsContent value="jobseekers">
              <div className="grid md:grid-cols-2 gap-16 items-center">
                <motion.div variants={containerVariants} initial="hidden" animate={isInView ? "visible" : "hidden"}>
                  ...
                  <motion.div className="space-y-6" variants={containerVariants}>
                    <FeatureItem icon={<ShieldCheck className="text-zordie-600" />} title="Skill Verification" description="Connect GitHub, LinkedIn and upload projects to verify your skills and get your verification badge." variants={itemVariants} />
                    
                    <FeatureItem icon={<Zap className="text-zordie-600" />} title="AI-Optimized Profile" description="Our AI optimizes your profile for each job application to maximize match rate." variants={itemVariants} />
                    
                    <FeatureItem icon={<Video className="text-zordie-600" />} title="Interview Practice" description="Prepare with AI-powered practice interviews tailored to your target roles." variants={itemVariants} />
                    
                    <FeatureItem icon={<Award className="text-zordie-600" />} title="Stand Out from the Crowd" description="Get hired based on your authentic, verified abilities rather than just your resume." variants={itemVariants} />
                  </motion.div>
                  ...
                  <div className="relative bg-white dark:bg-zordie-800 p-8 rounded-xl shadow-xl border border-gray-200 dark:border-zordie-700">
                    ...
                    <div className="flex items-center mb-8">
                      <div className="relative mr-4">
                        <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Profile" className="w-16 h-16 rounded-full object-cover border-2 border-white dark:border-zordie-700" />
                    ...
                    <div className="space-y-4 mb-6">
                      <div>
                        ...
                        <div className="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full">
                          <div className="h-full bg-gradient-to-r from-zordie-600 to-accent1 rounded-full" style={{
                          width: '92%'
                        }}></div>
                        </div>
                      </div>
...
const FeatureItem = ({
  ...
  return <motion.div className="flex items-start" variants={variants}>
