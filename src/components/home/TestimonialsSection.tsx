      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <SectionHeading
            ...
            subtitle="Hear how Zordie has transformed hiring processes and job searches"
            align="center"
          />
        </motion.div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-shrink-0 w-full max-w-xs">
              <img 
                ...
                alt="CEO Testimonial" 
                className="w-24 h-24 rounded-full object-cover border-4 border-white dark:border-zordie-700 mx-auto"
              />
            ...
            <div className="flex-1">
              ...
              <div className="mt-6 flex items-center">
                <img 
                  ...
                  alt="Company logo" 
                  className="h-6 dark:invert mr-3"
                />
...
const TestimonialCard = ({ testimonial, variants }) => {
  return (
    <motion.div
      variants={variants}
      className="bg-white dark:bg-zordie-800/50 p-6 rounded-xl shadow-md border border-zordie-100 dark:border-zordie-700 hover:shadow-lg transition-shadow duration-300 flex flex-col h-full relative overflow-hidden group"
    >
      ...
      <div className="flex justify-between items-start mb-4 relative z-10">
        <div className="flex items-center">
          <img 
            ...
            className="w-12 h-12 rounded-full object-cover mr-3 border-2 border-white dark:border-zordie-700 shadow-sm"
          />
          <div>
