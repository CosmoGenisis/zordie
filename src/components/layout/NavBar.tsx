        ...
        <div className="flex justify-between h-16">
                ...
                <Link
                  ...
                  className={`inline-flex items-center px-1 pt-1 text-sm font-medium ${
                    isActive(item.href)
                      ...
                      : "text-gray-600 hover:text-zordie-700"
                  }`}
                >
                  {item.name}
                </Link>
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-zordie-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-zordie-500"
            >
          ...
          <div className="px-3 py-3 border-t">
            <div className="flex flex-col space-y-3 pt-3">
              ...
              <Link to="/signup" className="w-full">
                <Button className="w-full btn-gradient" onClick={() => setMobileMenuOpen(false)}>
                  Sign Up
                </Button>
              </Link>
            </div>
