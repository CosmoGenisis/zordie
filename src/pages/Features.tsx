      ...
      <div className="py-24 bg-white dark:bg-zordie-950">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Revolutionary tools built for modern recruitment challenges"
            align="center"
          />
                    ...
                    <div className="pt-3 mt-auto border-t border-gray-100 dark:border-zordie-800/50">
                      <div className="flex flex-wrap gap-2">
                        {feature.tags.map((tag, tagIndex) => (
                          <span 
                            key={tagIndex}
                            className="px-3 py-1 text-xs font-medium rounded-full bg-zordie-50 text-zordie-700 dark:bg-zordie-800 dark:text-zordie-200"
                          >
                            {tag}
                          </span>
                        ))}
          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            >
              <div className="relative overflow-hidden rounded-2xl shadow-xl">
                ...
                <motion.div 
                  className="absolute top-6 right-6 flex items-center space-x-2 bg-white/90 dark:bg-zordie-800/90 backdrop-blur-sm p-3 rounded-lg border border-zordie-200 dark:border-zordie-700"
                  initial={{ opacity: 0, y: -20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <motion.div 
                  className="absolute bottom-6 left-6 flex items-center space-x-2 bg-white/90 dark:bg-zordie-800/90 backdrop-blur-sm p-3 rounded-lg border border-zordie-200 dark:border-zordie-700"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div 
                className="absolute -bottom-6 -right-6 bg-white dark:bg-zordie-800 p-4 rounded-xl shadow-lg border dark:border-zordie-700"
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-12">
            ...
            >
              ...
              <motion.div 
                className="absolute -top-6 -left-6 bg-white dark:bg-zordie-800 p-4 rounded-xl shadow-lg border dark:border-zordie-700"
                initial={{ opacity: 0, scale: 0.8 }}
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ delay: 0.3, duration: 0.5 }}
                viewport={{ once: true }}
      ...
      <div className="py-24 bg-gray-50 dark:bg-zordie-900">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Success stories from companies transforming their hiring"
            align="center"
          />
...
// Feature data
const statsData = [
  { value: "73%", label: "Faster Hiring" },
  { value: "99.4%", label: "Verification Accuracy" },
  { value: "60%", label: "Cost Reduction" },
  { value: "5x", label: "Better Candidates" }
];
