...
import { CheckCircle, ArrowRight, Briefcase, MapPin, Target, TrendingUp, Award, BadgeCheck, ThumbsUp, Users, Brain, Sparkles, ChevronRight, CircleCheck, CircleArrowUp, LayoutList } from 'lucide-react';
                ...
                <div className="bg-gradient-to-r from-blue-700 to-blue-800 p-6">
                  <div className="flex items-center mb-6">
                    <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-white flex-shrink-0">
                      <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=80" alt="Profile" className="w-full h-full object-cover" />
                    </div>
                    <div className="ml-4">
          ...
          duration: 0.6
            ...
            delay: index * 0.2
                ...
                <div className="flex mb-4">
                  {[...Array(5)].map((_, i) => <CircleArrowUp key={i} className="h-4 w-4 text-yellow-500" />)}
                </div>
