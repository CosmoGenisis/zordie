    ...
    <Layout>
            ...
            >
              <div className="relative overflow-hidden bg-gradient-to-tr from-zordie-900 to-zordie-700 rounded-2xl shadow-xl p-10">
                ...
                <div className="relative">
                  ...
                  <motion.div 
                    className="p-4 mt-5 border border-white/20 rounded-lg bg-white/5 backdrop-blur-sm"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: 1 }}
                  >
                    ...
                    <motion.div 
                      className="flex items-center mb-3 p-2 rounded-md bg-white/5"
                    ...
                    <motion.div 
                      className="flex items-center p-2 rounded-md bg-white/5"
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
              ...
              <motion.div 
                className="absolute -bottom-6 -left-6 bg-white dark:bg-zordie-800 p-4 rounded-xl shadow-lg border dark:border-zordie-700"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
      ...
      <div className="py-24 bg-white dark:bg-zordie-950">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <SectionHeading
            title="How Zordie AI Works for You"
            subtitle="Simple steps to transform your job search and career"
            align="center"
          />
      ...
      <div className="py-24 bg-gray-50 dark:bg-zordie-900">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <SectionHeading
            title="Job Search Challenges Solved"
            subtitle="How we help you overcome common career obstacles"
            align="center"
          />
      ...
      <div className="py-24 bg-gray-50 dark:bg-zordie-900">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="How job seekers like you have benefited from Zordie AI"
            align="center"
          />
