	...
	theme: {
		...
		extend: {
			colors: {
				...
				// New blue, orange, white, cyan color palette
				brandBlue: {
					50: '#eff6ff',
					100: '#dbeafe',
					200: '#bfdbfe',
				...
				// Pure white and vibrant cyan/orange for dark mode
				dark: {
					100: '#e0e0e0',
					200: '#c2c2c2',
					300: '#a3a3a3',
			...
			keyframes: {
				...
				"neon-pulse": {
					"0%, 100%": { 
						textShadow: "0 0 5px rgba(34, 211, 238, 0.7), 0 0 10px rgba(34, 211, 238, 0.5), 0 0 15px rgba(34, 211, 238, 0.3)"
					},
					"50%": { 
						textShadow: "0 0 10px rgba(34, 211, 238, 1), 0 0 20px rgba(34, 211, 238, 0.8), 0 0 30px rgba(34, 211, 238, 0.6)"
					},
				},
				"border-flow": {
					"0%, 100%": { 
			...
			backgroundImage: {
				...
				'blue-purple-gradient': 'linear-gradient(135deg, #3b82f6 0%, #22d3ee 100%)',
				'blue-purple-gradient-hover': 'linear-gradient(135deg, #2563eb 0%, #06b6d4 100%)',
			}
		}
	},
